...
//flowers
//syntax: (type,itMin,itMax,radius,start,scale,sWidth,sHeight,container,color,randomness,maxScale,timeLimit,timeMin,timeMax,timeMult,rotation)
flower('long',16,32,100,40,0,window.innerWidth,window.innerHeight,'container1',[0.2, 'navy', 0.4, 'blue', 0.7, 'pink', 0.95, 'white'],40,1.5,4000,400,600,1.5,8);
